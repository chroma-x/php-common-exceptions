# Contributing to PHP Common Exceptions
...
Here’s an example workflow for `php-common-exceptions` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/php-common-exceptions`
- Clone your project  

```
git clone git@github.com:yourname/php-common-exceptions
```

- Create a branch

```
cd php-common-exceptions
